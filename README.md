...
- **真实 POI 数据**：18,211 条香港 POI（18,075 家餐厅 + 136 个文化/娱乐/自然景点），餐厅来源 OpenRice 2021–2025 真实评论数据；景点含博物館、泳灘、郊野公園、主要景點等；75 个中文类别标签，88% 餐厅带多标签，LIKE 查询可命中任意标签
...
数据存储在 `route_planner/data/poi.csv`（18,211 条香港 POI，GitHub 上可直接查看表格）。

...
### POI 数据覆盖（18,211 条，香港全区）

**数据来源**：餐饮 — OpenRice 香港 2021–2025 年真实用户评论数据集；文化/娱乐/自然 — 政府开放数据 + 官方景点资料（136 条）。

| 指标 | 数值 |
|---|---|
| 总 POI 数 | 18,211 条（18,075 家餐厅 + 136 个文化/娱乐/自然景点） |
| 景点类型 | 博物館 18、泳灘 42、郊野公園 25、主要景點 13、公園 18、表演場地/露天劇場 8 等 |
| 覆盖地区 | 旺角 / 中環 / 東區 / 灣仔 / 觀塘 / 荃灣 … 共 204 个社区，area 字段 100% 填充（DeepSeek 地理编码） |
...
| i18n 覆盖 | _LOCATION_EN 收录全部 204 个社区，英文模式 area 字段 100% 可翻译 |

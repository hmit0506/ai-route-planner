...
_STEPS = {
    "zh-CN": {
        ...
        "refine_no_result": "未找到符合条件的替换地点，保留原地点",
        "refine_replaced":  "已选出替换地点：{name}",
    ...
    "zh-TW": {
        ...
        "enrich_done":      "已補充團購/排隊/趨勢資訊",
        "output_done":      "路線規劃完成，已生成地圖連結",
        "refine_start":     "正在替換：{name}（搜索 {city}{area} 的{cat}候選）",
        "refine_no_result": "未找到符合條件的替換地點，保留原地點",
        "refine_replaced":  "已選出替換地點：{name}",
    ...
    "en": {
        ...
        "enrich_done":      "Queue / deals / trend info added",
        "output_done":      "Route complete, map generated",
        "refine_start":     "Replacing: {name} (searching {cat} in {city} {area})",
        "refine_no_result": "No valid replacement found, keeping original",
        "refine_replaced":  "Replaced with: {name}",
